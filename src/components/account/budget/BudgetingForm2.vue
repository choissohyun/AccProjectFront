...
<!--        <b-col md="4">-->
<!--          <b-form-group>-->
<!--            <h3 style="font-size: 24px; font-weight: bold;">당기 : {{year}}</h3>-->
<!--          </b-form-group>-->
<!--        </b-col>-->
<!--        <b-col>-->
<!--          <b-button-->
...
<!--      &lt;!&ndash; 예산 입력 및 확인&ndash;&gt;-->
<!--      <b-col>-->

<!--        <b-row>-->
<!--          <b-form-group>-->
<!--            <b-card>-->
<!--              <h2 style="font-size: 24px; font-weight: bold;">예산편성</h2>-->
<!--              <b-row class="mb-sm-2">-->
...
<!--          <b-form-group>-->
<!--            <b-card>-->
<!--              <h2 style="font-size: 24px; font-weight: bold;">예산신청내역</h2>-->
<!--              <b-row class="mb-sm-2">-->
<!--                <b-col sm="1" class="text-sm-right"><b>1월</b></b-col>-->
<!--                <b-col sm="2">-->
